...
namespace GraphTutorial.Controllers
{
    public class CalendarController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                var userTimeZone = TZConvert.GetTimeZoneInfo(User.GetUserGraphTimeZone() ?? "UTC");
                var startOfWeekUtc = CalendarController.GetUtcStartOfWeekInTimeZone(DateTime.Today, userTimeZone);
            ...
            catch (ServiceException ex)
            {
                ...
                return View(new CalendarViewModel()).WithError("Error getting calendar view", ex.Message);
            }
        }
